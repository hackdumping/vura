...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        body {
            margin: 0; font-family: ${theme.fontFamily}, -apple-system, sans-serif;
        ...
        .back-btn {
            ...
            padding: 0; margin-bottom: 24px; cursor: pointer; display: flex; align-items: center;
        }
        ...
        .hero-inner {
            background: white; border-radius: 20px; padding: 12px; display: inline-flex;
            align-items: center; gap: 12px; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.1);
        }
        ...
        .choice {
            background: white; border: 1px solid #eef2f6; padding: 20px; border-radius: 16px;
        ...
        .field-box input {
            width: 100%; padding: 16px; border-radius: 12px; border: 1px solid #e2e8f0;
            font-size: 16px; outline: none; transition: border-color 0.2s;
        }
        .field-box input:focus { border-color: var(--primary); }
        ...
        .cta {
            ...
            width: 100%; transition: transform 0.2s, opacity 0.2s;
        }
        .cta:active { transform: scale(0.98); }
        .cta:disabled { opacity: 0.7; cursor: not-allowed; }

        .loader-wrap { display: flex; flex-direction: column; align-items: center; justify-content: center; py: 60px; text-align: center; }
        .spinner {
        ...
        .ebook-box {
            background: #f8fafc; border-radius: 16px; padding: 16px; display: flex; align-items: center;
            gap: 16px; margin-bottom: 32px; border: 1px dashed #cbd5e1;
        }
        ...
        .price-tag { font-size: 48px; font-weight: 800; color: var(--primary); }
...
<script>
  ...
  async function handleCapture(event, nextId){
    ...
    try {
      ...
      alert('Soumission réussie (Mode Simulation)');
      goTo(nextId);
    }
  }
